...
<font color="990000" size="3">
*<font color="999999" size="3">
Passwork &nbsp;<br><input type="password" name="pass" size="35"  value="<?php echo $pass;?>" tooltipText="Strong password, for eg. Ksa$567vFT " >&nbsp;&nbsp;&nbsp;&nbsp;
<br><br>

<font color="990000" size="3">
*<font color="999999" size="3">
Require Passwork : &nbsp; <br><input type="password" name="cpass" size="35" tooltipText="Password must match the password above" >&nbsp;&nbsp;&nbsp;&nbsp;
<br><br>
<font color="990000" size="3">
*<font color="999999" size="3">
...
Full Name :&nbsp;&nbsp;&nbsp;&nbsp; <br><input type="text" name="name" size="35"  value="<?php echo $name;?>" tooltipText="Your full name" > 
<br><br>
...
<a href="login.php"><font color="999999" size="3">Login</a>
 &nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
