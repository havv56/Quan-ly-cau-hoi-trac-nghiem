...
if(@$_POST['delcmember']>""){
foreach($_POST['delcmember'] as $key => $delcmember){
mysql_query("DELETE FROM dmember WHERE id='$delcmember' "); 
}
...
<?php
$query="SELECT * FROM dmember WHERE user='$search' OR name='$search' OR email='$search' OR city='$search' OR country='$search' OR groupname='$search' "; 
   $result = mysql_query($query) or die(mysql_error());         
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="member.php"><font color="666666" size="3">Back</a>



</td><form method="post" action="member.php">
...
<td background="images/bgn21.jpg" height="35"  width="80"><font color="ffffff">&nbsp;&nbsp;</td>
...
<tr onMouseOver="this.bgColor = '#e9e9e9'"
    ...
    bgcolor="#FFFFcc">
<td><center></td>
<td><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['user'];?></u></center></a></td>
<td ><center><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['name'];?></u></center></a></td>
<td ><center><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['email'];?></u></center></a></td>
<td ><center><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['groupname'];?></u></center></a></td>
<td ><center><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['country'];?></u></center></a></td>
<td ><a href="member.php?email=<?php echo $row['id']; ?>"><center><img src="images/delete.png" border="0"></center></a></td>
<td ><center></td>
</tr>
...
$query="SELECT * FROM dmember WHERE actstatus='1' ORDER BY date DESC LIMIT $page, 10"; 
...
<tr onMouseOver="this.bgColor = '#e9e9e9'"
    ...
    bgcolor="#FFFFcc">
<td><center></td>
<td ><center><input type="checkbox" name="delcmember[]" value="<?php echo $row['id']; ?>" ></center></td>

<td><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['user'];?></u></center></a></td>
<td ><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['name'];?></u></center></a></td>
<td ><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['email'];?></u></center></a></td>
<td ><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['groupname'];?></u></center></a></td>
<td ><a href="member.php?v=<?php echo $row['id']; ?>"> <font color="666666"><?php echo $row['country'];?></u></center></a></td>
<td ><a href="member.php?email=<?php echo $row['id']; ?>"><center><img src="images/delete.png" border="0"></center></a></td>
<td ><center></td>
</tr>
...
$query="SELECT * FROM dmember  WHERE actstatus='1' "; 
   $result = mysql_query($query) or die(mysql_error());         
              if(mysql_num_rows($result)>=0)
{
...
<tr onMouseOver="this.bgColor = '#e9e9e9'"
    ...
    bgcolor="#FFFFcc">
<td><center></td>
<td><a href="member.php?v=<?php echo $row['id']; ?>"><center><font color="666666"><?php echo $row['user'];?></u></center></a></td>
<td ><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['name'];?></u></center></a></td>
<td ><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['email'];?></u></center></a></td>
<td ><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['groupname'];?></u></center></a></td>
<td ><a href="member.php?v=<?php echo $row['id']; ?>"><font color="666666"><?php echo $row['country'];?></u></center></a></td>
<td ><a href="member.php?email=<?php echo $row['id']; ?>"><img src="images/delete.png" border="0"></center></a></td>
<td ><center></td>
</tr>
...
$query="SELECT * FROM dmember WHERE actstatus='1' AND groupname='$groupname' ORDER BY date DESC LIMIT $page, 10"; 
...
<td > <a href="member.php?v=<?php echo $row['id']; ?>"> <font color="666666"><?php echo $row['groupname'];?></u></center></a></td>
<td > <a href="member.php?v=<?php echo $row['id']; ?>"> <font color="666666"><?php echo $row['country'];?></u></center></a></td>
<td ><center><a href="member.php?email=<?php echo $row['id']; ?>"><center><img src="images/delete.png" border="0"></center></a></td>
<td ><center></td>
</tr>
...
<a href="member.php"><img src="images/back.jpg" border="0"></a><br>
...
New registration (<a href="member.php?activate=<?php echo $row['id']; ?>&v=<?php echo $row['id']; ?>">
...
?> (
<a href="member.php?reactivate=<?php echo $row['id']; ?>&v=<?php echo $row['id']; ?>">
